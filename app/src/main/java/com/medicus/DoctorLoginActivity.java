...
public class DoctorLoginActivity extends AppCompatActivity {
    ...
    @BindView(R.id.dl_input_email) EditText _emailText;
    @BindView(R.id.dl_input_password) EditText _passwordText;
    @BindView(R.id.dl_btn_login) Button _loginButton;
    @BindView(R.id.link_dl_signup) TextView _signupLink;
    @BindView(R.id.link_dl_changeprofile) TextView _changeprofileLink;
